...
const SignupScreen = ({ navigation }) => {
  ...
  const [resendCodeTimer, setResendCodeTimer] = useState(15);
  ...
  const codeRefs = [codeInput1, codeInput2, codeInput3, codeInput4];
  ...
  const handleSendCode = async () => {
    try {
      const response = await axios.post('http://192.168.18.12:3000/auth/sendVerificationCode', { phoneNumber: '+55' + phoneNumber.replace(/\D/g, '') });
  ...
  const handleVerifyCode = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.18.12:3000/auth/verifyPhoneNumber', { phoneNumber: '+55' + phoneNumber.replace(/\D/g, ''), code: fullCode });
      console.log(response.data);
        ...
        {!waitingForCode ? (
          <>
            ...
            <TouchableOpacity style={[styles.button, styles.buttonSocial]}>
              <Image source={require('assets/google-logo.png')} style={{ width: 24, height: 24, marginRight: 10 }} />
              <Text style={[styles.buttonText, styles.textBlack]}>Continuar com o Google</Text>
            </TouchableOpacity>
            ...
            >
              <Image source={require('assets/mail.png')} style={{ width: 24, height: 24, marginRight: 10 }} />
              <Text style={[styles.buttonText, styles.textBlack]}>Continuar com Email</Text>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.button, styles.buttonSocial]}
            onPress={() => navigation.navigate('Login')}
            >
              <Image source={require('assets/enter.png')} style={{ width: 24, height: 24, marginRight: 10 }} />
            ...
            >
              <Image source={require('assets/edit.png')} style={{ width: 24, height: 24, marginRight: 10 }} />
              <Text style={[styles.buttonText, styles.textBlack]}>Cadastrar</Text>
            </TouchableOpacity>
